...
$result = mysqli_query($conn,"SELECT * FROM servicerequest WHERE status = 'pending'");
	...
	<div id="page-wrapper">
				...
				<nav id="nav">
					<ul>
						...
						<li>
								<a> Manage Request </a>
							<ul>
								<li class="current"><a href="ViewRequestsSP.php">New Request</a>
		...
		<div id="features-wrapper">
					<div class="createrequest">
						<form action="createnewrequest.php" method="post" style="border:1px solid #ccc">
							<div class="createrequestcontainer">
								<br>
								<h2>View Open Service Requests</h2>
                <?php
                echo "<table border='1'>
                <tr>
                <th>Request ID</th>
                ...
                echo "<td>" . $row['servicetype'] . "</td>";
								...
								echo "<td><a href='Accept.php?id=".$row['requestID']."'>Accept</a></td>";
                echo "</tr>";
                }
                echo "</table>";
                ?>
